export const paintingData = [
    ...
    ...Array.from({ length: 4 }, (_, i) => ({
        ...
        info: {
            ...
            description: `This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty. Artwork ${i + 1
    ...
    ...Array.from({ length: 4 }, (_, i) => ({
        ...
        info: {
            title: `Van Gogh ${i + 9}`,
            artist: 'Vincent van Gogh',
            description: `With its striking use of color and brushwork, Artwork ${i + 9
